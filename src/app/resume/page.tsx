									...
									<ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
										{experience.items.map((i, idx) => (
											<li key={idx} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
												...
												<h3 className="text-xl max-w-[320px] min-h-[60px] text-center lg:text-left">{i.position}</h3>
								...
								<ScrollArea className="h-[400px]">
									<ul className="grid grid-cols-1 gap-[30px]">
										{education.items.map((i, idx) => (
											<li key={idx} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
												<span className="text-accent">{i.duration}</span>
												<h3 className="text-xl max-w-[320px] min-h-[60px] text-center lg:text-left">{i.degree}</h3>
												<div className="flex items-center gap-3">
													<span className="w-[6px] h-[6px] rounded-full bg-accent" />
